 ...
 * Generated on: 2026-04-12T20:44:11.589Z
 *
...
export const schemas = {
        ...
        properties: {
            forecast: {
                ...
                properties: {
                    pressureTrend: {
                        type: 'string',
                        enum: ['falling', 'rising', 'steady', 'unknown']
                    },
                    forecast: {
                        type: 'string'
                    },
    ...
    homeTracker_upload_Input: {
        ...
        properties: {
            ...
            detectedLowBattery: {
                description:
                    'True if board detected a battery voltage low enough to trigger shutdown',
                type: 'boolean'
            },
            detectedForcedReset: {
                description:
                    'True if board detected it restarted after an interrupt forced a restart',
                type: 'boolean'
            },
            detectedInternalSensorFailure: {
                description:
...
export type Chords_GetLinksVisitsCount_Output = FromSchema<
    typeof schemas.chords_getLinksVisitsCount_Output
>;
...
export type Clipboard_GetAllEntries_Output = FromSchema<
    typeof schemas.clipboard_getAllEntries_Output
>;
export type Clipboard_GetPublicEntries_Output = FromSchema<
    typeof schemas.clipboard_getPublicEntries_Output
>;
...
export type Cookbook_ListIngredients_Output = FromSchema<
    typeof schemas.cookbook_listIngredients_Output
>;
...
export type HomeTracker_GetSensorsDataForDashboard_Output = FromSchema<
    typeof schemas.homeTracker_getSensorsDataForDashboard_Output
>;
export type HomeTracker_GetWeatherForecast_Output = FromSchema<
    typeof schemas.homeTracker_getWeatherForecast_Output
>;
export type HomeTracker_HistogramData_Input = FromSchema<
    typeof schemas.homeTracker_histogramData_Input
>;
export type HomeTracker_HistogramData_Output = FromSchema<
    typeof schemas.homeTracker_histogramData_Output
>;
export type HomeTracker_HistogramDataPublic_Input = FromSchema<
    typeof schemas.homeTracker_histogramDataPublic_Input
>;
export type HomeTracker_HistogramDataPublic_Output = FromSchema<
    typeof schemas.homeTracker_histogramDataPublic_Output
>;
export type HomeTracker_UpdateSensorMetadata_Input = FromSchema<
    typeof schemas.homeTracker_updateSensorMetadata_Input
>;
export type HomeTracker_UpdateSensorMetadata_Output = FromSchema<
    typeof schemas.homeTracker_updateSensorMetadata_Output
>;
...
export type Openapi_DefinitionJson_Output = FromSchema<
    typeof schemas.openapi_definitionJson_Output
>;
export type PersonalTracker_GetAll_Output = FromSchema<
    typeof schemas.personalTracker_getAll_Output
>;
export type PersonalTracker_Upload_Input = FromSchema<typeof schemas.personalTracker_upload_Input>;
export type PersonalTracker_Upload_Output = FromSchema<
    typeof schemas.personalTracker_upload_Output
>;
...
export type Reactor_GetEntriesForPublic_Output = FromSchema<
    typeof schemas.reactor_getEntriesForPublic_Output
>;
export type Misc_R_Output = FromSchema<typeof schemas.misc_r_Output>;
export type WebWatcher_CreateWatcher_Input = FromSchema<
    typeof schemas.webWatcher_createWatcher_Input
>;
export type WebWatcher_CreateWatcher_Output = FromSchema<
    typeof schemas.webWatcher_createWatcher_Output
>;
export type WebWatcher_DeleteWatcher_Input = FromSchema<
    typeof schemas.webWatcher_deleteWatcher_Input
>;
export type WebWatcher_DeleteWatcher_Output = FromSchema<
    typeof schemas.webWatcher_deleteWatcher_Output
>;
export type WebWatcher_GetAllWatchers_Output = FromSchema<
    typeof schemas.webWatcher_getAllWatchers_Output
>;
export type WebWatcher_ToggleWatcherEnabled_Input = FromSchema<
    typeof schemas.webWatcher_toggleWatcherEnabled_Input
>;
export type WebWatcher_ToggleWatcherEnabled_Output = FromSchema<
    typeof schemas.webWatcher_toggleWatcherEnabled_Output
>;
...
export class APIClient {
    ...
    chords = {
         ...
         */
        addLinkVisit: async (
            input: Chords_AddLinkVisit_Input
        ): Promise<Chords_AddLinkVisit_Output> => {
            validateInput(schemas.chords_addLinkVisit_Input, input, 'chords.addLinkVisit');
            const response = await this.fetch('/chords/addLinkVisit', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
        ...
        checkLinks: async (): Promise<Chords_CheckLinks_Output> => {
            const response = await this.fetch('/chords/checkLinks', { method: 'GET' });
            const output = await response.json();
        ...
        getAll: async (): Promise<Chords_GetAll_Output> => {
            const response = await this.fetch('/chords/getAll', { method: 'GET' });
            const output = await response.json();
        ...
        getLinksVisitsCount: async (): Promise<Chords_GetLinksVisitsCount_Output> => {
            const response = await this.fetch('/chords/getLinksVisitsCount', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.chords_getLinksVisitsCount_Output,
                output,
        ...
        updateAll: async (input: Chords_UpdateAll_Input): Promise<Chords_UpdateAll_Output> => {
            ...
            const response = await this.fetch('/chords/updateAll', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
    ...
    clipboard = {
        ...
        addEntry: async (input: Clipboard_AddEntry_Input): Promise<Clipboard_AddEntry_Output> => {
            ...
            const response = await this.fetch('/clipboard/addEntry', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
         ...
         */
        deleteEntry: async (
            input: Clipboard_DeleteEntry_Input
        ): Promise<Clipboard_DeleteEntry_Output> => {
            validateInput(schemas.clipboard_deleteEntry_Input, input, 'clipboard.deleteEntry');
            const response = await this.fetch('/clipboard/deleteEntry', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
        ...
        getAllEntries: async (): Promise<Clipboard_GetAllEntries_Output> => {
            const response = await this.fetch('/clipboard/getAllEntries', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.clipboard_getAllEntries_Output,
                output,
        ...
        getPublicEntries: async (): Promise<Clipboard_GetPublicEntries_Output> => {
            const response = await this.fetch('/clipboard/getPublicEntries', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.clipboard_getPublicEntries_Output,
                output,
        ...
        view: async (): Promise<Clipboard_View_Output> => {
            const response = await this.fetch('/clipboard/view', { method: 'GET' });
            const output = await response.json();
    ...
    cookbook = {
        ...
        addRecipe: async (input: Cookbook_AddRecipe_Input): Promise<Cookbook_AddRecipe_Output> => {
            ...
            const response = await this.fetch('/cookbook/addRecipe', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
        ...
        getRecipe: async (input: Cookbook_GetRecipe_Input): Promise<Cookbook_GetRecipe_Output> => {
            ...
            const response = await this.fetch('/cookbook/getRecipe', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
        ...
        listIngredients: async (): Promise<Cookbook_ListIngredients_Output> => {
            const response = await this.fetch('/cookbook/listIngredients', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.cookbook_listIngredients_Output,
                output,
        ...
        listRecipes: async (): Promise<Cookbook_ListRecipes_Output> => {
            const response = await this.fetch('/cookbook/listRecipes', { method: 'GET' });
            const output = await response.json();
    ...
    ephemerides = {
         ...
         */
        getRange: async (
            input: Ephemerides_GetRange_Input
        ): Promise<Ephemerides_GetRange_Output> => {
            validateInput(schemas.ephemerides_getRange_Input, input, 'ephemerides.getRange');
            const response = await this.fetch('/ephemerides/getRange', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
        ...
        getToday: async (): Promise<Ephemerides_GetToday_Output> => {
            const response = await this.fetch('/ephemerides/getToday', { method: 'GET' });
            const output = await response.json();
    ...
    gravitrips = {
        ...
        getNewGame: async (): Promise<Gravitrips_GetNewGame_Output> => {
            const response = await this.fetch('/gravitrips/getNewGame', { method: 'GET' });
            const output = await response.json();
    ...
    health = {
        ...
        getRemoteTime: async (): Promise<Health_GetRemoteTime_Output> => {
            const response = await this.fetch('/health/getRemoteTime', { method: 'GET' });
            const output = await response.json();
    ...
    homeTracker = {
        ...
        getSensorsDataForDashboard:
            async (): Promise<HomeTracker_GetSensorsDataForDashboard_Output> => {
                const response = await this.fetch('/homeTracker/getSensorsDataForDashboard', {
                    method: 'GET'
                });
                const output = await response.json();
                validateOutput(
                    schemas.homeTracker_getSensorsDataForDashboard_Output,
                    output,
        ...
        getWeatherForecast: async (): Promise<HomeTracker_GetWeatherForecast_Output> => {
            const response = await this.fetch('/homeTracker/getWeatherForecast', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.homeTracker_getWeatherForecast_Output,
                output,
         ...
         */
        histogramData: async (
            input: HomeTracker_HistogramData_Input
        ): Promise<HomeTracker_HistogramData_Output> => {
            validateInput(
                schemas.homeTracker_histogramData_Input,
                input,
                'homeTracker.histogramData'
            );
            const response = await this.fetch('/homeTracker/histogramData', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
            const output = await response.json();
            validateOutput(
                schemas.homeTracker_histogramData_Output,
                output,
                'homeTracker.histogramData'
            );
         ...
         * Authentication: none
         */
        histogramDataPublic: async (
            input: HomeTracker_HistogramDataPublic_Input
        ): Promise<HomeTracker_HistogramDataPublic_Output> => {
            validateInput(
                schemas.homeTracker_histogramDataPublic_Input,
                input,
                'homeTracker.histogramDataPublic'
            );
            const response = await this.fetch('/homeTracker/histogramDataPublic', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
            const output = await response.json();
            validateOutput(
                schemas.homeTracker_histogramDataPublic_Output,
                output,
                'homeTracker.histogramDataPublic'
            );
         ...
         * Authentication: user2
         */
        updateSensorMetadata: async (
            input: HomeTracker_UpdateSensorMetadata_Input
        ): Promise<HomeTracker_UpdateSensorMetadata_Output> => {
            validateInput(
                schemas.homeTracker_updateSensorMetadata_Input,
                input,
                'homeTracker.updateSensorMetadata'
            );
            const response = await this.fetch('/homeTracker/updateSensorMetadata', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
            const output = await response.json();
            validateOutput(
                schemas.homeTracker_updateSensorMetadata_Output,
                output,
                'homeTracker.updateSensorMetadata'
            );
        ...
        ): Promise<HomeTracker_Upload_Output> => {
            validateInput(schemas.homeTracker_upload_Input, input, 'homeTracker.upload');
            const response = await this.fetch('/homeTracker/upload', {
                method: 'POST',
    ...
    openapi = {
        ...
        definitionJson: async (): Promise<Openapi_DefinitionJson_Output> => {
            const response = await this.fetch('/openapi/definition.json', { method: 'GET' });
            const output = await response.json();
    ...
    personalTracker = {
        ...
        getAll: async (): Promise<PersonalTracker_GetAll_Output> => {
            const response = await this.fetch('/personalTracker/getAll', { method: 'GET' });
            const output = await response.json();
         ...
         */
        upload: async (
            input: PersonalTracker_Upload_Input
        ): Promise<PersonalTracker_Upload_Output> => {
            validateInput(schemas.personalTracker_upload_Input, input, 'personalTracker.upload');
            const response = await this.fetch('/personalTracker/upload', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
    ...
    reactor = {
        ...
        addEntry: async (input: Reactor_AddEntry_Input): Promise<Reactor_AddEntry_Output> => {
            ...
            const response = await this.fetch('/reactor/addEntry', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
        ...
        getEntriesForPublic: async (): Promise<Reactor_GetEntriesForPublic_Output> => {
            const response = await this.fetch('/reactor/getEntriesForPublic', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.reactor_getEntriesForPublic_Output,
                output,
    ...
    misc = {
        ...
        r: async (params: { linkId: string }): Promise<Misc_R_Output> => {
            const response = await this.fetch('/r/:linkId'.replace(':linkId', params.linkId), {
                method: 'GET'
            });
            const output = await response.json();
    ...
    webWatcher = {
         ...
         */
        createWatcher: async (
            input: WebWatcher_CreateWatcher_Input
        ): Promise<WebWatcher_CreateWatcher_Output> => {
            validateInput(
                schemas.webWatcher_createWatcher_Input,
                input,
                'webWatcher.createWatcher'
            );
            const response = await this.fetch('/webWatcher/createWatcher', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
            const output = await response.json();
            validateOutput(
                schemas.webWatcher_createWatcher_Output,
                output,
                'webWatcher.createWatcher'
            );
         ...
         */
        deleteWatcher: async (
            input: WebWatcher_DeleteWatcher_Input
        ): Promise<WebWatcher_DeleteWatcher_Output> => {
            validateInput(
                schemas.webWatcher_deleteWatcher_Input,
                input,
                'webWatcher.deleteWatcher'
            );
            const response = await this.fetch('/webWatcher/deleteWatcher', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
            const output = await response.json();
            validateOutput(
                schemas.webWatcher_deleteWatcher_Output,
                output,
                'webWatcher.deleteWatcher'
            );
        ...
        getAllWatchers: async (): Promise<WebWatcher_GetAllWatchers_Output> => {
            const response = await this.fetch('/webWatcher/getAllWatchers', { method: 'GET' });
            const output = await response.json();
            validateOutput(
                schemas.webWatcher_getAllWatchers_Output,
                output,
         ...
         * Authentication: user2
         */
        toggleWatcherEnabled: async (
            input: WebWatcher_ToggleWatcherEnabled_Input
        ): Promise<WebWatcher_ToggleWatcherEnabled_Output> => {
            validateInput(
                schemas.webWatcher_toggleWatcherEnabled_Input,
                input,
                'webWatcher.toggleWatcherEnabled'
            );
            const response = await this.fetch('/webWatcher/toggleWatcherEnabled', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(input)
            });
            const output = await response.json();
            validateOutput(
                schemas.webWatcher_toggleWatcherEnabled_Output,
                output,
                'webWatcher.toggleWatcherEnabled'
            );
    ...
    webStats = {
        ...
        record: async (
            apiKey: string,
            input: WebStats_Record_Input
        ): Promise<WebStats_Record_Output> => {
            validateInput(schemas.webStats_record_Input, input, 'webStats.record');
            const response = await this.fetch('/web-stats/record', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${apiKey}` },
                body: JSON.stringify(input)
            });
